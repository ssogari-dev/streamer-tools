...
| 스크립트 이름 | 설명 | 버전 | 설치 |
| :--- | :--- | :---: | :---: |
| **SOOP 별풍선 추출기** | SOOP VOD 채팅창에서 **별풍선 후원 내역**을 추출하여 CSV로 저장합니다. | v1.8 | [📥 설치하기](https://raw.githubusercontent.com/ssogari-dev/streamer-tools/main/UserScript/soop-vod-extractor.user.js) |
